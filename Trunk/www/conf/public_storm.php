...
Settings::setVar('graphviz_type', 'neato', 'public_storm', 'GraphViz command');
...
Settings::setVar('user_storms_per_page', '15', 'public_storm', 'number of storm printed on each user page');
