...
final class meteor extends Plugins
{
	...
	public function __construct()
	{
		...
		{
			Settings::addCss('screen', Settings::getVar('ROOT').Settings::getVar('theme_dir').'plugins/'.self::$name.'/styles/admin.css', 'admin.css');
		}
		//Settings::addJs('text/javascript', 'http://meteor.internetcollaboratif.info/meteor.js', 'none.js');
		Settings::addJs('text/javascript', Settings::getVar('ROOT').Settings::getVar('theme_dir').'plugins/'.self::$name.'/scripts/'.self::$name.'.js', 'all.js');
	}
