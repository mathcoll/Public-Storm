...
define('OAUTH_CONSUMER_KEY', Settings::getVar('Yahoo Consumer Key'));
define('OAUTH_CONSUMER_SECRET', Settings::getVar('Yahoo Consumer Secret'));

$progname = $argv[0];
$debug = Settings::getVar('debug level'); // Set to 1 for verbose debugging output
