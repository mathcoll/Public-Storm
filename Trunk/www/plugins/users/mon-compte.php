...
Settings::setVar('title', i18n::_("mon_compte"));
...
Settings::addCss('screen', Settings::getVar('theme_dir').'plugins/users/styles/mon-compte.css');
$content = $sPlug->fetch("mon-compte.tpl", "plugins/users");
