$jQuery(document).ready(function() {
	if ($jQuery("#message").html() != "") {
		...
		$jQuery("#message").dialog("option", "buttons", {
			"Fermer" : function() {
...
function habillage_sondage() {
	$jQuery("body")
			.append(
					"<div id=\"sondage\" style=\"position:relative;width:304px;height:204px;\"><span class=\"messageToHide\"></span><object style=\"padding:2px;position:absolute;overflow:hidden;clip:rect(2px 302px 202px 2px);\" data=\"http://www.easy-sondage.fr/sondages/index.php?num=b91b1facf3b3a7890177f02ac188f14c\" type=\"text/html\" width=\"304\" height=\"204\"><a href=\"http://www.blog-poll.com/p/Web/b91b1facf3b3a7890177f02ac188f14c.html\">Cliquez-ici pour accéder au sondage.</a></object></div>");
	// $jQuery("body").append("<div id=\"sondage\"><script
	// type=\"text/javascript\"
	// src=\"http://www.blog-poll.com/sondages/poll.php?num=b91b1facf3b3a7890177f02ac188f14c\"></script><noscript><p><a
	// href=\"http://www.blog-poll.com/p/Web/b91b1facf3b3a7890177f02ac188f14c.html\">Cliquez-ici
	// pour accéder au sondage.</a></p></noscript></div>");
	$jQuery("#sondage").dialog(
			{
				title : "Veuillez patienter pendant le chargement...",
				width : 340,
				height : 240,
				open : function(event, ui) {
					$jQuery("#message").dialog("option", "sondage",
							"Sondage Public-Storm");
				}
			});
}

function validerEmail(email) {
	$jQuery.get(BASE_URL + "/utilisateurs/valideremail.php?email=" + email,
			function(data) {
				if (data) {
...
function validerIdentifiant(login) {
	$jQuery.get(BASE_URL + "/utilisateurs/valideridentifiant.php?login="
			+ login, function(data) {
		if (data) {
